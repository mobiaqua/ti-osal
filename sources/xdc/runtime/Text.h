...
__extern xdc_Int xdc_runtime_Text_matchRope__F( xdc_runtime_Text_RopeId rope, xdc_CString pat, xdc_Int* lenp );
__extern xdc_Int xdc_runtime_Text_matchRope__R( xdc_runtime_Text_RopeId rope, xdc_CString pat, xdc_Int* lenp );
